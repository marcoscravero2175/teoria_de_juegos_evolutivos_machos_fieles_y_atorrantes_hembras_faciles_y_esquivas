...
class RealizaUnaSimulacionDeMachosYHembrasMuestraEvolucion(tornado.web.RequestHandler):
	def get(self):

		elements = self.application.visualization_elements
		print("Hola mundo")
		self.render("realizaUnaSimulacionDeMachosYHembrasMuestraEvolucion.html", port=self.application.port,
...
class ModularServer(tornado.web.Application):
    ...
    homePage = (r"/", HomePage)
    realizaUnaSimulacionDeMachosYHembrasMuestraEvolucion = (r'/realizaUnaSimulacionDeMachosYHembrasMuestraEvolucion', RealizaUnaSimulacionDeMachosYHembrasMuestraEvolucion)
    ...
    handlers = [homePage, realizaUnaSimulacionDeMachosYHembrasMuestraEvolucion, socket_handler, static_handler, local_handler]
